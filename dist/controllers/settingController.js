...
export const getSettings = async (req, res) => {
    try {
        ...
        const mergedSettings = {
            ...
            practiceAreas: settings?.practiceAreas || DEFAULT_PRACTICE_AREAS,
            feeDefaults: {
                ...DEFAULT_FEE_DEFAULTS,
                ...(settings?.feeDefaults || {}),
                aos: {
                    ...DEFAULT_FEE_DEFAULTS.aos,
                    ...(settings?.feeDefaults?.aos || {})
                },
                o1: {
                    ...DEFAULT_FEE_DEFAULTS.o1,
                    ...(settings?.feeDefaults?.o1 || {})
                }
            }
        };
        return res.json({
...
export const updateSettings = async (req, res) => {
    try {
        const { companyName, specialistId, filingFee, premiumFee, asylumFee, whatsappAlerts, emailRequests, appointmentReminders, quietHours, feeDefaults, practiceAreas } = req.body;
