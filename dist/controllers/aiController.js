...
export const draftLegalText = async (req, res) => {
    ...
    if (geminiApiKey) {
        try {
            ...
            const systemInstruction = "You are JurisAI, an expert US immigration attorney specializing in EB-2 NIW (National Interest Waiver) and EB-1A petitions. " +
